<div class="container-fluid bg-green mt-3" id="footer-wrap" style="background-image: url('/assets/images/aes-logo-footer.png');background-position:top left;background-repeat:no-repeat;">
  <div class="container">
<!--    <?php snippet("logo") ?>-->
